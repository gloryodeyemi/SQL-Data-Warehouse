...
-- Transforming and Loading silver.crm_sales_details
...
SELECT
    ...
    END AS sls_due_dt, -- Handle invalid dates and change date type
    CASE
...
-- Transforming and Loading silver.erp_cust_az12
